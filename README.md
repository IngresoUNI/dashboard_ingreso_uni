...
```
cd existing_repo
git remote add origin http://mtc-dvintsgd01/equipo-odtd/equipo-2024/chatbots/telegrambot/telegrambot-dashboard.git
git branch -M main
...
- [ ] [Set up project integrations](http://mtc-dvintsgd01/equipo-odtd/equipo-2024/chatbots/telegrambot/telegrambot-dashboard/-/settings/integrations)
